...
#Clean junk info off file

#Filter out participants who fail attention checks

#Obtain mean explanation ratings

#Sum auxillary measures into individual socres
...
#input parameters into mixed-effects linear regression model

#Run regression

#Obtain bootstrapped confidence intervals

#Run individual linear regressions for each auxillary measure
```
